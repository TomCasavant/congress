...
from congress.models.summary import Summary
from typing import Dict

class SummariesResult(ListResult[Summary]):
    def __init__(self, status_code: int, message: str = "", data: Dict = None, rest_adapter = None):
        ...
        if data and 'summaries' in data:
            self._items = [Summary(**summary_data) for summary_data in data['summaries']]
